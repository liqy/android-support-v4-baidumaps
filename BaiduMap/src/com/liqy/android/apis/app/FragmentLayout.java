...
package com.liqy.android.apis.app;
...
import com.liqy.android.apis.Locations;
import com.liqy.android.apis.Locations.Entry;
import com.liqy.android.apis.R;
...
public class FragmentLayout extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boolean dualPane = detailsFrame != null
				&& detailsFrame.getVisibility() == View.VISIBLE;

		// Decide where to place TitlesFragment.
		// See fragment_layout.xml in res/layout/ and res/layout-land/ to see
		// the difference
		...
		mMapViewContainer = LayoutInflater.from(this).inflate(R.layout.mapview,
				null);
	...
	public static class MapFragment extends Fragment {
		...
		/**
		 * Create a new instance of MapFragment, initialized to show the
		 * location Entry at 'index'.
		 */
		...
		public void onCreate(Bundle arg0) {
			...
			super.getActivity().initMapActivity(mBMapMan);
			super.onCreate(arg0);
		}
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			/*
			 * We've tied the MapView's lifecycle to the MapActivity
			 * (FragmentLayout extends FragmentActivity which extends
			 * MapActivity (in the android-support-v4-googlemaps library)).
			 * 
			 ...
			 * 
			 * We could "inject" (or pass in) these via MapFragment's
			 * constructor, but it seems to break the general usage pattern of
			 * Fragments (i.e. pass in a Bundle of arguments, each of which is
			 * Parcelable / Serializable).
			 * 
			 * I chose to do call up to FragmentLayout to do this, but injecting
			 * the references into the constructor might be better. Its up to
			 * you.
			 */
			...
			if (null != mMapView) {
				...
				mMapController.animateTo(new GeoPoint((int) (e.lat * 1.0e6),
						(int) (e.lng * 1.0e6)));
		...
		public void onDestroyView() {
			...
			// message,
			// we only inflate the map's XML layout once. When we try to add it
			// a second
			// time, we get "IllegalStateException: The specified child already
			// has a
			...
			ViewGroup parentViewGroup = (ViewGroup) mMapViewContainer
					.getParent();
